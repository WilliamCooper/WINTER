...
RPlot22 <- function (data) {
  ...
  CUHSAS <- ncvar_get (netCDFfile, "CUHSAS_RPC")
  CPCASP <- ncvar_get (netCDFfile, "CS200_RPT")
  ...
  CellSizes <- ncatt_get (netCDFfile, "CUHSAS_RPC", "CellSizes")
  CellLimitsU <- CellSizes$value
  CellSizes <- ncatt_get (netCDFfile, "CS200_RPT", "CellSizes")

...
RPlot5 <- function (data) { 
  ...
  mtext(paste(FigFooter,'generated by RPlot5',FigDatestr),1,outer=T,cex=0.75); labelled=T
...
#         pch=20, col=c('blue', tgreen))
  ...
  # pulling legend out of plotWAC to increase font size
  legend('bottomright',c("CAVP_DPT", "CAVP_DPB", "PSFC"),col=c("blue","darkgreen","red"),text.col=c("blue","darkgreen","red"),lty=c(1,2,1),lwd=c(2,1,1))
